...
async def main():
    ...
    await bot_client.send_message(MY_CHAT_ID, "🤖 **Red Packet Bot is Online!**\nYouTube, X နှင့် Telegram အားလုံးကို စောင့်ကြည့်နေပါပြီ။")
    ...
    while True:
        ...
        try:
            records = get_sheet().get_all_records()
            yt_channels = [r['Link'] for r in records if r['Type'].upper() == 'YT']
